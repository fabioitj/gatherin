...
export default async function NewsDetailPage({ params }: NewsDetailPageProps) {
  ...
  const formattedDate = format(new Date(news.publishedAt), "MMMM dd, yyyy", {
    locale: enUS
  });
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <div className="bg-purple-50 border-l-4 border-purple-500 p-6 mb-8 rounded-r-lg">
          <h2 className="text-lg font-semibold text-purple-900 mb-3">Summary</h2>
        ...
        <footer className="bg-gray-50 rounded-2xl p-6 border-0">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="text-sm text-gray-600">
              <p className="font-medium mb-1">Published on {formattedDate}</p>
